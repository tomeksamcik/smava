...
public class AccountPersistentServiceTest {
	...
	public void getAccount() throws AccountServiceException,
		...
		Account added = accountPersistentService.addAccount(session,
				new Account("A", "1", null));
		Account returned = accountPersistentService.getAccount(session,
				added.getId());
	...
	public void updateAccount() throws AccountServiceException,
		...
		Account added = accountPersistentService.addAccount(session,
				new Account("A", "1", null));
		Account updated = accountPersistentService.updateAccount(session,
	...
	public void updateNotFound() throws AccountServiceException,
			AccountServiceEntityNotFoundException,
			AccountServiceNonUniqueException {
		accountPersistentService.updateAccount(session, 99l, new Account("A",
				"1", null));
	}
