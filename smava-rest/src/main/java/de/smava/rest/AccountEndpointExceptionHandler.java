...
class GlobalControllerExceptionHandler {
	...
	public ResponseEntity<Error> handleAccountServiceNonUniqueException(
	...
	public ResponseEntity<Error> handleAccountServiceEntityNotFoundException(
			HttpServletRequest req, Exception e) {
	...
	public ResponseEntity<Error> handleAccountServiceException(
			HttpServletRequest req, Exception e) {
